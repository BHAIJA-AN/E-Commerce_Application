      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            Container(
              padding: const EdgeInsets.only(top: 53, left: 23, right: 23),
              child: Column(
                children: [
                  TextField(
                    ...
                    children: [
                      ...
                      TextButton(
                          style: TextButton.styleFrom(
                            ...
                            foregroundColor:
                                const Color.fromARGB(255, 106, 112, 124),
                          ),
                          onPressed: () {
                ...
                child: Column(
                  children: [
                    const Text(
                      "Or Login with",
                      style: TextStyle(
                          color: Color.fromARGB(255, 1, 1, 1), fontSize: 16),
                    ),
                    const SizedBox(
                      height: 20,
                    ),
